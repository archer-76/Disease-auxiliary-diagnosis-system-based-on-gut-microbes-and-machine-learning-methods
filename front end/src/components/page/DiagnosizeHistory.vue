<template>
  <div>
    ...
    >
      ...
      <el-table-column prop="epoch" label="epoch" width="120" sortable>
      </el-table-column>
      <el-table-column prop="batchsize" label="batchsize" width="120" sortable>
      </el-table-column>
      <el-table-column prop="dataset" label="dataset" width="180" sortable>
      </el-table-column>
      <el-table-column prop="threshold" label="threshold" width="120" sortable>
      </el-table-column>
      ...
      <el-table-column label="详情" width="130" align="center">
        <template slot-scope="scope">
          <el-button
            ...
            icon="el-icon-search"
            title="查看"
            @click="sendHistory($event, scope.row)"
            >查看</el-button
          >
        </template>
      </el-table-column>
...
export default {
  methods: {
    ...
    getData() {
      ...
      const path = "http://127.0.0.1:5000/DiagnosizeHistory";
      axios
        .get(path)
